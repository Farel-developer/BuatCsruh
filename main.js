...
var range_value = document.getElementById('love_range').value;
  document.getElementById('txt_range').innerText = range_value + '%'
    if(kick == '1'){
        ...
        window.location.href = 'https://www.api.whatsaap.com/send?text=' + msg;
    }
    if(kick == '2'){
        alert('Yahh Kok Nggak Sih :(')
        kick = '0'
...
function send_msg(){
    alert('Makasih Yk udah mau terima aku apa adanya')
    window.location.href = 'https://api.whatsaap.com/send?text=Iya+aku+mau+sama+kamu'
}